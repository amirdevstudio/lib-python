...
def get_default_draw_color() -> Color:
    return default_render_color


def set_default_draw_color(color: Color):
    global default_render_color
    default_render_color = color


def get_default_draw_thickness() -> int:
    return default_render_thickness


def set_default_draw_thickness(thickness: int):
    global default_render_thickness
    default_render_thickness = thickness


def get_default_draw_font_scale() -> float:
    return default_render_font_scale


def set_default_draw_font_scale(font_scale: float):
